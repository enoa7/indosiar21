<?php
	...
	$string = "agnez-mo-boy-magnet-konser-raya-21";
	...
	$pageDesc = $hometitle;
	$socialShareImg = "http://hut.indosiar.com/asset/images/vod/vod-thumb-16.png";
	...
	<div class="content">
		<div class="container">
			...
			<div class="video col-xs-12 spacepad">
				<iframe class="vidio-embed" src="http://www.vidio.com/embed/244532-agnez-mo-boy-magnet-konser-raya-21?autoplay=false&amp;player_only=true&amp;" scrolling="no" frameborder="0" allowfullscreen></iframe>
			</div>
		</div>	
	</div>	
