		...
		<div class="container spacepad">
			...
			<div class="activity one clearfix">
				...
				<div class="details col-xs-12">
					<div class="name col-xs-12 col-sm-6">saldo</div>
					<div class="amount col-xs-12 col-sm-6">Rp196,079,100.00</div>
				</div>
			...
			<div class="activity two clearfix">
				<h3 class="title text-left">SD Inpres Bengo 2, Kabupaten Gowa Sulawesi Selatan</h3>
				<div class="video col-xs-12 text-center">
					<div class="">
				...
				<div class="details col-xs-12">
					<div class="name col-xs-12 col-sm-6">saldo</div>
					<div class="amount col-xs-12 col-sm-6"> Rp384,659,100.00 </div>
				</div>
				<div class="progress col-xs-12 nopadding hidden-xs">
